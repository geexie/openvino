...
namespace LayerTestsDefinitions {
    ...
    void CodegenBert::SetUp() {
        ...
        auto shapeM = ngraph::Shape{1, /*4*/1, /*32*/8*2+7, /*32*/8*2+7};
        auto input3 = std::make_shared<ngraph::opset1::Parameter>(ngraph::element::f32, shapeM);
        ...
        // ToDo: snippet support for non scalar constants
        // auto c0 = ngraph::op::Constant::create(ngraph::element::f32, shape, vals);
    ...
    //     auto gelu = std::make_shared<ngraph::opset2::Gelu>(mm);
    //     auto mm2     = std::make_shared<ngraph::opset1::MatMul>(gelu, input3);

    //     std::vector<float> vals(ngraph::shape_size(shape));
    //     auto c0 = ngraph::op::Constant::create(ngraph::element::f32, shape, vals);
    //     auto add2    = std::make_shared<ngraph::opset1::Subtract>(mm2, c0);
    ...
    //     auto mul    = std::make_shared<ngraph::opset1::Multiply>(add, mm);
