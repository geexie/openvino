...
void op::Subgraph::set_generator(std::shared_ptr<ngraph::snippets::Generator> generator) {
...
snippets::Schedule  op::Subgraph::generate(const BlockedShapeVector& output_shapes, const BlockedShapeVector& input_shapes) {
    ...
    // return ptr != nullptr;
    return {work_size, canBeLinearized, ptr};
}
